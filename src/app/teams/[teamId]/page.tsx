          ...
          {canEdit && (
              ...
              >
                <DialogTrigger asChild>
                  <Button data-testid="new-doc-open">
                  ...
                  <div className="space-y-4 py-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        disabled={isCreating}
                        data-testid="new-doc-file-input"
                      />
                      {file ? (
                        <div className="flex items-center gap-3 p-3 rounded-lg border bg-muted/50">
                          ...
                          <Button
                            ...
                            disabled={isCreating}
                            data-testid="new-doc-remove-file"
                        ...
                        <button
                          ...
                          data-testid="new-doc-select-file"
                        >
