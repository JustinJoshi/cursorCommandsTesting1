        ...
        - generic [ref=e32]:
          - generic [ref=e34]:
            ...
            - textbox "Team Name" [ref=e36]:
              ...
              - text: qa-team-1771649673013-61
          - button "Create Team" [ref=e38]
  - region "Notifications alt+T":
    - list:
      - listitem [ref=e39]:
        - img [ref=e41]
        - generic [ref=e46]: "[CONVEX M(teams:create)] [Request ID: fdbb7156b460c476] Server Error Could not find public function for 'teams:create'. Did you forget to run `npx convex dev` or `npx convex deploy`? Called by client"
